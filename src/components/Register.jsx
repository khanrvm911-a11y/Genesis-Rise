    ...
    <div className="min-h-screen bg-sl-gradient flex items-center justify-center px-4 py-8 relative overflow-hidden">
      ...
      >
        ...
        <motion.button
          ...
          className="w-full flex items-center justify-center gap-3 px-5 py-4 rounded-xl border border-sl-purple-light/30 bg-sl-purple-light/5 hover:bg-sl-purple-light/15 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed group mb-6"
        ...
        >
          ...
          <div className="flex flex-col items-start">
            ...
            <span className="text-sl-purple-light/60 text-xs">Fastest way to get started</span>
          </div>
          {socialLoading === 'google' && (
            <svg className="w-4 h-4 animate-spin text-white/60 ml-auto" fill="none" viewBox="0 0 24 24">
              <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
              <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" />
            </svg>
          )}
          <svg className="w-4 h-4 text-sl-purple-light/40 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
