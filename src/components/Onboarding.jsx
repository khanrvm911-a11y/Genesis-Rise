...
function OptionCard({ label, desc, icon: Icon, selected, onClick }) {
  return (
    <button
      type="button"
      onClick={onClick}
      ...
      <div className="py-4 md:py-6">
        ...
        >
          <button
            ...
            onClick={handleSave}
            disabled={saving}
            className="group relative inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-gradient-to-r from-sl-purple to-amber-500 text-white font-bold text-base rounded-xl overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-sl-purple/25 hover:scale-[1.03] active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sl-purple focus-visible:ring-offset-2 focus-visible:ring-offset-sl-dark min-h-[52px] min-w-[200px] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:hover:shadow-none"
          >
            {saving ? (
              ...
              <div>
                {showBack && (
                  <button
                    type="button"
                    onClick={goBack}
                    className="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-sl-gray-light hover:text-white transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sl-purple focus-visible:ring-offset-2 focus-visible:ring-offset-sl-dark rounded-lg"
                  >
